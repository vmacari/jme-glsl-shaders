...
public class LightBlow_Lighting_System extends SimpleApplication {

    public static void main(final String[] args) {
        final LightBlow_Lighting_System app = new LightBlow_Lighting_System();
        app.start();
    }
    ...
    public void simpleInitApp() {
        ...
        final TextureKey skyhi = new TextureKey("ShaderBlow/Textures/Water256.dds", true);
        ...
        final Spatial char_boy = this.assetManager.loadModel("ShaderBlow/Models/LightBlow/jme_lightblow.mesh.xml");
        final Material mat = this.assetManager
                .loadMaterial("ShaderBlow/Materials/LightBlow/Lighting_System/LightBlow_Base.j3m");
        char_boy.setMaterial(mat);
        TangentBinormalGenerator.generate(char_boy);
        this.rootNode.attachChild(char_boy);

        final Spatial char_boy2 = this.assetManager.loadModel("ShaderBlow/Models/LightBlow/jme_lightblow.mesh.xml");
        final Material mat2 = this.assetManager
                .loadMaterial("ShaderBlow/Materials/LightBlow/Lighting_System/LightBlow_HemiLighting_1.j3m");
        ...
        final Spatial char_boy3 = this.assetManager.loadModel("ShaderBlow/Models/LightBlow/jme_lightblow.mesh.xml");
        final Material mat3 = this.assetManager
                .loadMaterial("ShaderBlow/Materials/LightBlow/Lighting_System/LightBlow_HemiLighting_2.j3m");
        ...
        final Spatial char_boy4 = this.assetManager.loadModel("ShaderBlow/Models/LightBlow/jme_lightblow.mesh.xml");
        final Material mat4 = this.assetManager
                .loadMaterial("ShaderBlow/Materials/LightBlow/Lighting_System/LightBlow_Base_Specular.j3m");
