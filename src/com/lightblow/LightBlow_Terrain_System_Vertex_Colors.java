...
public class LightBlow_Terrain_System_Vertex_Colors extends SimpleApplication {


    
    
  public static void main(String[] args) {
    LightBlow_Terrain_System_Vertex_Colors app = new LightBlow_Terrain_System_Vertex_Colors();
    app.start();
  }
