...
//    private Vector3f vect3 = new Vector3f();
     ...
     */
    public SimpleRefractionProcessor(AssetManager manager) {
        this.manager = manager;
        material = new Material(manager, "MatDefs/SimpleRefraction/SimpleRefraction.j3md");
...
//            displayMap(rm.getRenderer(), dispReflection, 256);
            displayMap(rm.getRenderer(), dispDepth, 256);
        }
    }
...
//        refractionView.addProcessor(new RefractionProcessor());
     ...
     * @param spat
     */
    public void setRefractionScene(Spatial spat) {
