...
//        this.rm.setForcedTechnique(null);    
    ...
    protected void loadTextures(final AssetManager manager) {
        this.normalTexture = (Texture2D) manager.loadTexture("ShaderBlow/Textures/Refraction/water_normalmap.png");
        ...
        this.dudvTexture = (Texture2D) manager.loadTexture("ShaderBlow/Textures/Refraction/dudv_map.png");
